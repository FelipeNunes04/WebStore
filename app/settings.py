...
DATABASES = {
    'default': {
        ...
        'NAME': 'Virtualia$default',                      # Or path to database file if using sqlite3.
        'USER': 'Virtualia',                      # Not used with sqlite3.
        'PASSWORD': '12345678',                  # Not used with sqlite3.
        'HOST': 'Virtualia.mysql.pythonanywhere-services.com',                      # Set to empty string for localhost. Not used with sqlite3.
